  ...
  return (
    <div className="home-container">
      <header data-thq="thq-navbar" className="home-navbar">
        <span className="home-logo">Brandify</span>
        <div
      ...
      <section className="home-hero">
        <div className="home-heading">
          <h1 className="home-header">Create your own personal branding!</h1>
          <p className="home-caption">
            A custom brand personality based on your own brand
          </p>
        </div>
            ...
            <div className="home-main1">
              <div className="home-content02">
                <h2 className="home-header02">
                  Create your own brand personality
                </h2>
